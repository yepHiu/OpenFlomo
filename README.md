...
**新功能**
- 多语言支持：添加日语 (日本語) 支持
- PrimeVue 组件：语言切换改为下拉选择框
- PrimeVue 组件：添加 Toast 通知组件替换浏览器 alert
- PrimeVue 组件：数据管理弹窗添加日期选择器

**优化**
- i18n 优化：热力图组件支持多语言
- i18n 优化：标签侧边栏支持多语言
- i18n 优化：笔记输入区域支持多语言
- i18n 优化：所有组件使用统一的 i18n key
- 文档：添加 CLAUDE.md 项目开发指南
- 文档：添加项目结构文档 docs/ProjectStructure.md
- 文档：添加跨平台适配文档 docs/CrossPlatform.md
- 文档：添加优化建议文档 docs/Optimization.md
